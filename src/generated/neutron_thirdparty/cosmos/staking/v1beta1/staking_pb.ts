 ...
 *
 * @generated from enum cosmos.staking.v1beta1.InfractionType
 */
export enum InfractionType {
  /**
   * UNSPECIFIED defines an empty infraction type.
   *
   * @generated from enum value: INFRACTION_TYPE_UNSPECIFIED = 0;
   */
  UNSPECIFIED = 0,
   ...
   *
   * @generated from enum value: INFRACTION_TYPE_DOUBLE_SIGN = 1;
   */
  DOUBLE_SIGN = 1,
   ...
   *
   * @generated from enum value: INFRACTION_TYPE_DOWNTIME = 2;
   */
  DOWNTIME = 2,
}
// Retrieve enum metadata with: proto3.getEnumType(InfractionType)
proto3.util.setEnumType(InfractionType, "cosmos.staking.v1beta1.InfractionType", [
  { no: 0, name: "INFRACTION_TYPE_UNSPECIFIED" },
  { no: 1, name: "INFRACTION_TYPE_DOUBLE_SIGN" },
  { no: 2, name: "INFRACTION_TYPE_DOWNTIME" },
]);
